"""
Django settings for skills_runtime_service project.
...
INSTALLED_APPS = [
    ...
    "runtime_api.apps.RuntimeApiConfig",
]
...
ROOT_URLCONF = "skills_runtime_service.urls"
...
WSGI_APPLICATION = "skills_runtime_service.wsgi.application"
